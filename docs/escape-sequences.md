...
|DCS 1000 q | tmux control mode | Bridges tmux into the WezTerm multiplexer. Manually launched control clients and [supervised persistent sessions](config/lua/config/tmux_control.md) are supported. |
