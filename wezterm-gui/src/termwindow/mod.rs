...
impl TermWindow {
    ...
    pub fn perform_key_assignment(
        ...
        match assignment {
            ...
            DecreaseWindowPaneFontSize => self.decrease_window_pane_font_size(),
            IncreaseWindowPaneFontSize => self.increase_window_pane_font_size(),
            ResetWindowPaneFontSize => self.reset_window_pane_font_size(),
            ...
            TogglePaneSidebar => {
                ...
                let hidden = !tab.left_sidebar_hidden();
