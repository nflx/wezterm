    ...
    pub fn paint_tab_bar(&mut self, layers: &mut TripleLayerQuadAllocator) -> anyhow::Result<()> {
        ...
        self.render_screen_line(
            RenderScreenLineParams {
                ...
                pane_top_pixel_y: tab_bar_y,
                pane_pixel_height: tab_bar_height,
                ...
                fonts: std::rc::Rc::clone(&self.fonts),
                font_scale: ordered_float::NotNan::new(self.fonts.get_font_scale()).unwrap(),
                shape_key: None,
