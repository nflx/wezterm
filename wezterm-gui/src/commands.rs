...
pub fn derive_command_from_key_assignment(action: &KeyAssignment) -> Option<CommandDef> {
    Some(match action {
        ...
        DecreasePaneFontSize => CommandDef {
            brief: "Decrease pane font size".into(),
            doc: "Scales the active pane font size smaller by 10%".into(),
            keys: vec![],
            args: &[ArgType::ActivePane],
            menubar: &["View", "Font Size"],
            icon: Some("md_format_size"),
        ...
        IncreasePaneFontSize => CommandDef {
            brief: "Increase pane font size".into(),
            doc: "Scales the active pane font size larger by 10%".into(),
            keys: vec![],
            args: &[ArgType::ActivePane],
            menubar: &["View", "Font Size"],
            icon: Some("md_format_size"),
